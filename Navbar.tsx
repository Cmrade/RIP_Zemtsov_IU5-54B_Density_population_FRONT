...
const MyNavbar: React.FC = () => {
  ...
  const { currentApplication } = useAppSelector((state) => state.cart);
  ...
  const cartItemsCount = currentApplication?.orders?.length || 0;
        ...
        <Container>
          ...
          <BootstrapNavbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              {isAuthenticated ? (
                <>
                  <Nav.Link onClick={() => handleNavigation('/applications')}>
                    Заявки
                    {cartItemsCount > 0 && (
